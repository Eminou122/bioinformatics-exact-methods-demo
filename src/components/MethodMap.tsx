...
const content: Record<Language, MethodMapCopy> = {
  fr: {
    ...
    runnable: [
      ...
      { id: 'ilp2-plus', name: 'ILP2+', label: 'Exact integration', desc: 'ILP2 avec arrêt anticipé après le premier gagnant canonique faisable, sans sauter l’énumération.', route: '/methods/ilp2-plus' },
  ...
  en: {
    ...
    runnable: [
      ...
      { id: 'ilp2-plus', name: 'ILP2+', label: 'Exact integration', desc: 'ILP2 with early termination after the first feasible canonical winner, without skipping enumeration.', route: '/methods/ilp2-plus' },
  ...
  ar: {
    ...
    runnable: [
      ...
      { id: 'ilp2-plus', name: 'ILP2+', label: 'Exact integration', desc: 'ILP2 مع إيقاف مبكر بعد أول فائز قانوني ممكن، من دون تجاوز التعداد.', route: '/methods/ilp2-plus' },
